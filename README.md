...
## Conclusion
This repository is meant to serve as a guide or demonstration of key computational theory concepts, particularly in relation to the secure hash algorithm and the concepts it highlights like hashing. It provides practical implementations and explanations to help understand these fundamental topics in computer science as well as my understanding of them. Overall I found this module both challenging and rewarding as it tasked me with interacting with problems from many different perspectives and from many different areas of computer science which I had never previously done. The ability to effectively problem solve and think of solutions based on the theoretical material and SHA-256 documentation available was incredible interesting too.